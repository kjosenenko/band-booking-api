...
class SlotsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create slot" do
    assert_difference('Slot.count') do
      post slots_url, params: { slot: { show_set_id: @slot.show_set_id, time: @slot.time } }, as: :json
    end
  ...
  test "should update slot" do
    patch slot_url(@slot), params: { slot: { show_set_id: @slot.show_set_id, time: @slot.time } }, as: :json
    assert_response 200
  end
