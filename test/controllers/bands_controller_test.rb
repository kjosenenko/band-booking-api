...
class BandsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create band" do
    assert_difference('Band.count') do
      post bands_url, params: { band: { description: @band.description, genre_id: @band.genre_id, name: @band.name } }, as: :json
    end
  ...
  test "should update band" do
    patch band_url(@band), params: { band: { description: @band.description, genre_id: @band.genre_id, name: @band.name } }, as: :json
    assert_response 200
  end
